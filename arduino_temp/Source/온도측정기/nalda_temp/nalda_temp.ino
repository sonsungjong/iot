...
void setup() {
  ...
  tft.setTextSize(10); // 글씨 크기 (가로최대 13) (세로최대 10)
  tft.setTextColor(WHITE); // 글씨 색
  tft.setRotation(2); // 0 : 세로 출력, 1 : 가로 출력, 2: 거꾸로 세로 출력, 3: 거꾸로 가로 출력
...
//     사장님 지시로 테스트를 위해 추가===========================
      ...
      tft.fillScreen(GREEN);
      tft.setTextSize(9); // 글씨 크기 (가로최대 13) (세로최대 10)
      tft.setCursor(0, 120); // 위치(가로, 세로)
